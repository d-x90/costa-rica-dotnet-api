...
namespace CostaRicaApi.Services {
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(ExpenseContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        private string CreateJwtToken(User user) {
            ...
            var key = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes(_configuration["JWT_Key"]));
